...
const PRESET_GRAPHS: PresetGraph[] = [
  {
    ...
    icon: TrendingUp,
    parameters: ['baro_alt', 'ctun_alt', 'gps_alt'],
    chartType: 'area',
    priority: 1,
    category: 'critical',
  ...
  },
  {
    ...
    icon: Navigation,
    parameters: ['att_roll', 'att_pitch', 'att_yaw'],
    chartType: 'line',
    priority: 1,
    category: 'critical',
  ...
  },
  {
    ...
    icon: Navigation,
    parameters: ['gps_hdop', 'gps_vdop', 'gps_satellites'],
    chartType: 'line',
    priority: 2,
    category: 'monitoring',
  ...
  },
  {
    ...
    icon: Settings,
    parameters: ['servo_output_1', 'servo_output_2', 'servo_output_3', 'servo_output_4'],
    chartType: 'line',
    priority: 2,
    category: 'monitoring',
  ...
  },
  {
    ...
    icon: Settings,
    parameters: ['rc_input_1', 'rc_input_2', 'rc_input_3', 'rc_input_4'],
    chartType: 'line',
    priority: 2,
    category: 'analysis',
  ...
  },
  {
    ...
    icon: AlertTriangle,
    parameters: ['vibe_x', 'vibe_y', 'vibe_z'],
    chartType: 'line',
    priority: 2,
    category: 'monitoring',
